package cn.encmys.ykdz.forest.hypha.context;
...
public class Context {
    ...
    @NotNull
    private Config config = new Config(RoundingMode.HALF_UP);
    ...
    public void declareReference(@NotNull String name, boolean isConst, boolean isExported) {
        ...
        declareReference(name, new Reference(name, new Value(null)));
    }
